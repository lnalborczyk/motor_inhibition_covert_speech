...
\def\Address{$^{1}$Aix-Marseille Université, LPC, CNRS UMR 7290, Marseille, France \\
$^{2}$Aix-Marseille Université, LNC, CNRS UMR 7291, Marseille, France \\
...
\def\corrEmail{ladislas.nalborczyk@univ-grenoble-alpes.fr}
