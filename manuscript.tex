...
% Broadly construed, motor imagery can be defined as the mental process by which one rehearses an action without engaging in the physical movements involved in this particular action

% Mentally anticipating or rehearsing verbal actions allows us to become better at performing them \citep[e.g.,][]{toth_does_2020}, to explore/practise novel situations \citep{babar}, or to rehearse past situations \citep{babar}.
